            ...
            m_bShowCellSpaceInfo(false)
{
  ...
  //setup the AgentLeader
  //determine a random starting position for the AgentLeader
  Vector2D SpawnPos = Vector2D(cx / 2.0 + RandomClamped() * cx / 2.0,
                               cy / 2.0 + RandomClamped() * cy / 2.0);

  //instantiate new AgentLeader at a random position
  ...
  for (int a=1; a<Prm.NumAgents; ++a)
  {
    ...
    //instantiate new AgentPoursuiveur at a random position
    AgentPoursuiveur* pAgentPoursuiveur = new AgentPoursuiveur(this,
                                                               ...
                                                               Prm.MaxTurnRatePerSecond, //max turn rate
                                                               Prm.VehicleScale);        //scale
   //Put AgentPoursuiveur in the container of vehicle
